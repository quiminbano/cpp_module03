...
/*   Updated: 2023/06/05 18:19:00 by corellan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _HitPoints(100), _EnergyPoints(50), _AttackDamage(20), _Name("unknown"), _DeathCounter(0)
{
...
ClapTrap::ClapTrap(std::string name) : _HitPoints(100), _EnergyPoints(50), _AttackDamage(20), _Name(name), _DeathCounter(0)
{
