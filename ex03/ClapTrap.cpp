...
/*   Updated: 2023/06/07 09:43:19 by corellan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _HitPoints(10), _EnergyPoints(10), _AttackDamage(0), _Name("unknown_clap_name"), _DeathCounter(0), _MaxHP(10)
{
...
ClapTrap::ClapTrap(std::string name) : _HitPoints(10), _EnergyPoints(10), _AttackDamage(0), _Name(name), _DeathCounter(0), _MaxHP(10)
{
...
{
	std::cout << "Copy assigment operator called for ClapTrap." << std::endl;
	*this = rhs;
	return (*this);
}
